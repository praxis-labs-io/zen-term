...
enum ConfigWriter {
    ...
    /// only kind that existed before floats could be reordered — become a full contiguous sequence on the first reorder,
    ...
    /// below it inherit the slot it left and it slides down the dock.
