...
/// feel). Each backend honors what it can: the libghostty backend maps every field to ghostty
/// config, SwiftTerm honors the cursor/Option subset and ignores the scroll multiplier and
/// cursor thickness (it owns its own scroll handling and cursor rendering).
