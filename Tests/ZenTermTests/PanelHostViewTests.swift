...
/// keybind always (swapping to a "· Focus Mode" ⌘F variant while zoomed); a pane shows a
/// "Terminal pane · Focus Mode" header only while zoomed. Per the house rule "GUI controls
