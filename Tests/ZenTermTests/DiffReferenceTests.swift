...
/// ways nothing on screen shows: a range rendered as `42-42`, or a deleted file handed line numbers
/// that no longer exist, both look fine in the viewer and send the agent somewhere useless.
